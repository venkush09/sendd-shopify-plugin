		...
		var content ;
		 ...
		 if(len > 0){
			$('.select_box:checkbox:checked').each(function(index){
					...
					content = content + '<br><div class="c_type"><label>Content</label><input type="radio" checked value="P" name="content_type" class="content_type">Product <input type="radio" value="D" name="content_type" class="content_type">Documents</div></div></div></div>';
